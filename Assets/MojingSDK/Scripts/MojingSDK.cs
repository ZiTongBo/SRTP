...
public class MojingSDK
{
    ...
    private static bool Unity_CanEnterMojingWorld()
    {
        return true;
    }
    ...
    public static void Unity_Device_SetFixInfo(float[] pPosition)
    {
    ...
    [DllImport(dllName)]
    public static extern void Unity_Device_SetFixInfo(float[] pPosition);
